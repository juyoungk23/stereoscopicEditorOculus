...
namespace BNG
{
    public class VRKeyboard : MonoBehaviour
    {
        ...
        public void UpdateInputField(string key)
        {
            ...
            bool caretAtEnd = !AttachedInputField.isFocused || caretPosition == textLength;
            ...
            else
            {
                ...
                {
                    string preText = caretPosition > 0 ? currentText.Substring(0, caretPosition) : "";
                    MoveCaretUp();
        ...
        {
            StartCoroutine(DecreaseInputFieldCaretRoutine());
        }
        ...
        IEnumerator IncreaseInputFieldCaretRoutine()
        {
            ...
            AttachedInputField.caretPosition += 1;
            AttachedInputField.ForceLabelUpdate();
        }

        IEnumerator DecreaseInputFieldCaretRoutine()
        {
            yield return new WaitForEndOfFrame();
            AttachedInputField.caretPosition -= 1;
            AttachedInputField.ForceLabelUpdate();
