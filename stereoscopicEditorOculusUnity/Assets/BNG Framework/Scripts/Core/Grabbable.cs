...
namespace BNG
{
    ...
    public class Grabbable : MonoBehaviour
    {
        ...
        public float ThrowForceMultiplier = 0; // 2f;
        ...
        public float ThrowForceMultiplierAngular = 0; // 1.5f; // Multiply Angular Velocity times this
        ...
        public bool SnapHandModel = false;
        ...
        public float MoveVelocityForce = 0; // 3000f;
        public float MoveAngularVelocityForce = 0; // 90f;
